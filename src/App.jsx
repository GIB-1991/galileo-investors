...
function RequireAccess({ user, children }) {
  ...
  if (access.loading) return <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center'}}><div style={{color:'var(--color-accent)',fontSize:'1.2rem'}}>...</div></div>
