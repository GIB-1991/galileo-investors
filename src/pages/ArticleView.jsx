  ...
  return (
    <div style={{ maxWidth: 780, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: '1rem', flexWrap: 'wrap' }}>
        {article.category && (
          <span style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: '.78rem', fontWeight: 600, color: 'var(--color-accent)', background: 'rgba(212,175,55,0.1)', padding: '4px 11px', borderRadius: 14 }}>
