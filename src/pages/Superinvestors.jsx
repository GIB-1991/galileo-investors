...
const INV=[
  ...
  {id:'PS',name:'Bill Ackman',fund:'Pershing Square',img:'/api/imgproxy?url=https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fcommons%2Fthumb%2F0%2F07%2FValeant_Pharmaceuticals%2527_Business_Model_%2528headshot%2529.jpg%2F200px-Valeant_Pharmaceuticals%2527_Business_Model_%2528headshot%2529.jpg',aum:11400,style:'Activist',n:11,color:'#4f8ef7',
  ...
  {id:'DQ',name:'Stanley Druckenmiller',fund:'Duquesne Family Office',img:'/api/imgproxy?url=https%3A%2F%2Ffm.cnbc.com%2Fapplications%2Fcnbc.com%2Fresources%2Fimg%2Feditorial%2F2019%2F05%2F15%2F106461697-1557951041754druckenmiller.jpg',aum:3600,style:'Macro',n:68,color:'#2dd87a',
  ...
  {id:'AM',name:'David Tepper',fund:'Appaloosa Management',img:'/api/imgproxy?url=https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fcommons%2Fthumb%2F3%2F3d%2FDavid_Tepper_01.jpg%2F200px-David_Tepper_01.jpg',aum:7890,style:'Value',n:47,color:'#a855f7',
  ...
  {id:'SC',name:'Michael Burry',fund:'Scion Asset Management',img:'/api/imgproxy?url=https%3A%2F%2Ffm.cnbc.com%2Fapplications%2Fcnbc.com%2Fresources%2Fimg%2Feditorial%2F2021%2F12%2F16%2F106937598-1639667498961-gettyimages-1351794928-MICHAEL_BURRY.jpeg',aum:114,style:'Contrarian',n:9,color:'#f05252',
...
const ACTIVITY=[
  ...
  {q:'Q3 2025',קניות:298,מכירות:210},{q:'Q4 2025',קניות:321,מכירות:196},{q:'Q4 2025',קניות:321,מכירות:196},
]
                ...
                <div style={{marginTop:'1rem',paddingTop:'1rem',borderTop:'1px solid var(--color-border)'}}>
                  ...
                  {inv.top5.map((h,i)=>(
                    <div key={h.t} style={{display:'flex',alignItems:'center',gap:8,marginBottom:5}}>
                      ...
                      <img src={'https://logo.clearbit.com/'+h.t.toLowerCase().replace(/[^a-z]/g,'')+'com'} alt="" onError={e=>{e.target.src='https://ui-avatars.com/api/?name='+encodeURIComponent(e.target.alt||'?')+'&size=120&background=555&color=fff&bold=true'}} style={{width:18,height:18,borderRadius:3,objectFit:'contain',background:'white',padding:1,flexShrink:0}}/>
