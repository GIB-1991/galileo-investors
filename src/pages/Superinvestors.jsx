...
const INV=[
  ...
  {id:'DQ',name:'Stanley Druckenmiller',fund:'Duquesne Family Office',img:'/api/portrait?name=druckenmiller',aum:3600,style:'Macro',n:68,color:'#2dd87a',
  ...
  {id:'SC',name:'Michael Burry',fund:'Scion Asset Management',img:'/api/portrait?name=burry',aum:114,style:'Contrarian',n:9,color:'#f05252',
