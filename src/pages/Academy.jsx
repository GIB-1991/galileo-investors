    ...
    <div>
      ...
      {loading ? (
        ...
        <div style={{display:'flex',flexDirection:'column',gap:8}}>
          {filtered.map(item => (
            <div key={item.id} style={{background:'var(--color-surface)',border:'1px solid '+(open===item.id?'rgba(212,175,55,0.25)':'var(--color-border)'),borderRadius:12,overflow:'hidden',transition:'border-color 200ms'}}>
